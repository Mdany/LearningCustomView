...
public class ViewPagerIndicator extends LinearLayout {
    ...
    private void init() {
        this.setBackgroundDrawable(getResources().getDrawable(R.drawable.view_pager_bg));
        paint = new Paint();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (isSetData) {
            ...
            for (int i = 0; i < mDatas.size(); i++) {
                ...
                tv.setTextColor(getResources().getColor(R.color.red_deep));
        ...
        if (getChildCount() > 0) {
            for (int i = 0; i < getChildCount(); i++) {
                if (i == currentPosition) {
                    ((TextView) getChildAt(currentPosition)).setTextColor(getResources().getColor(R.color.red_deep));
                } else {
